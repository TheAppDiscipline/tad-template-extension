...
- Si no existe, marcar BLOCKER: "PROFILE=LAUNCH+ requiere scorecard.yaml. Crea desde la plantilla del scorecard en el vault (producto aparte)."
...
- El reporte debe ser interpretable por un no-programador: usar terminos del glosario (en el vault, producto aparte), no jerga interna del tooling.
